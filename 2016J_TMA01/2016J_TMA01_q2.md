...
#this resulted in 345 rows, but I realise that this de-duplication relies on the postcode format being exactly the 
...
```
    ...
    <matplotlib.text.Text at 0xaf1e864c>
...
```
    ...
    <matplotlib.text.Text at 0xaf14246c>
